...
Main.__name__ = true;
Main.main = function() {
	sirius_Sirius.seo.init(sirius_seo_SEOTool.LEVEL_2);
	sirius_Sirius.seo.product.build("Test");
	sirius_Sirius.seo.publish();
};
Math.__name__ = true;
...
sirius_seo_SEOTool.prototype = {
	...
	,publish: function() {
		...
		sirius_Sirius.log("Sirius::SEO --PUBLISH",10);
	}
...
var sirius_seo_SEO = function(type) {
	...
	sirius_Sirius.log("Sirius::SEO @" + this.typeOf() + " --CREATED",10);
};
...
sirius_seo_SEOTool.LEVEL_1 = sirius_seo_SEOTool.WEBSITE | sirius_seo_SEOTool.BREADCRUMBS;
sirius_seo_SEOTool.PRODUCT = 4;
sirius_seo_SEOTool.LEVEL_2 = sirius_seo_SEOTool.LEVEL_1 | sirius_seo_SEOTool.PRODUCT;
