...
class sirius_db_tools_QueryBuilder implements sirius_db_tools_IQueryBuilder{
	...
	public function _updateSet($parameters) {
		$q = (new _hx_array(array()));
		sirius_utils_Dice::All($parameters, array(new _hx_lambda(array(&$parameters, &$q), "sirius_db_tools_QueryBuilder_3"), 'execute'), null);
		return $q->join(",");
	}
...
function sirius_db_tools_QueryBuilder_3(&$parameters, &$q, $p, $v) {
	{
