...
class Flag {
	...
	public function dropAll ($bits = null) {
		...
		Dice::Values($bits, function ($v) use (&$_gthis) {
			#src/jotun/logical/Flag.hx:168: characters 4-11
			$_gthis->drop($v);
		});
	...
	public function putAll ($bits = null) {
		...
		Dice::Values($bits, function ($v) use (&$_gthis) {
			#src/jotun/logical/Flag.hx:158: characters 4-10
			$_gthis->put($v);
		});
	...
	public function toggle ($bit) {
		#src/jotun/logical/Flag.hx:126: characters 3-35
		$this->value = Flag::FToggle($this->value, 1 << $bit);
