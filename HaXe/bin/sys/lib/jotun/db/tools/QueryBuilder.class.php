...
class jotun_db_tools_QueryBuilder implements jotun_db_tools_IQueryBuilder{
	...
	public function _insert($parameters, $dataset) {
		...
		$i = 0;
		jotun_utils_Dice::All($parameters, array(new _hx_lambda(array(&$dataset, &$i, &$q, &$r), "jotun_db_tools_QueryBuilder_0"), 'execute'), null);
	...
	public function _updateSet($parameters, $dataset) {
		$q = (new _hx_array(array()));
		jotun_utils_Dice::All($parameters, array(new _hx_lambda(array(&$dataset, &$q), "jotun_db_tools_QueryBuilder_1"), 'execute'), null);
		return $q->join(",");
	}
	public function _order($obj) {
		$r = (new _hx_array(array()));
		jotun_utils_Dice::All($obj, array(new _hx_lambda(array(&$r), "jotun_db_tools_QueryBuilder_2"), 'execute'), null);
		return $r->join(",");
	}
	public function _conditions($obj, $props, $joiner) {
		...
		$s = $joiner;
		$b = true;
		if(Std::is($obj, _hx_qtype("jotun.db.Clause"))) {
			jotun_utils_Dice::Values(_hx_field($obj, "conditions"), array(new _hx_lambda(array(&$_gthis, &$joiner, &$props, &$r), "jotun_db_tools_QueryBuilder_3"), 'execute'), null);
			$s = $obj->joiner();
		} else {
			if(Std::is($obj, _hx_qtype("Array"))) {
				jotun_utils_Dice::All($obj, array(new _hx_lambda(array(&$_gthis, &$joiner, &$props, &$r), "jotun_db_tools_QueryBuilder_4"), 'execute'), null);
			} else {
				if($obj !== null) {
					if(Std::is(_hx_field($obj, "value"), _hx_qtype("Array"))) {
						$r1 = $r->length;
						$tmp = jotun_utils_Filler::to(_hx_field($obj, "condition"), _hx_anonymous(array("p" => _hx_field($obj, "param"))), null);
						$r[$r1] = $tmp;
						jotun_utils_Dice::All(_hx_field($obj, "value"), array(new _hx_lambda(array(&$props), "jotun_db_tools_QueryBuilder_5"), 'execute'), null);
					} else {
						$r2 = $r->length;
						$tmp1 = jotun_utils_Filler::to(_hx_field($obj, "condition"), _hx_anonymous(array("p" => _hx_field($obj, "param"))), null);
						$r[$r2] = $tmp1;
	...
	public function copy($from, $to, $clause = null, $filter = null, $limit = null) {
		...
		jotun_utils_Dice::Values($entries, array(new _hx_lambda(array(&$_gthis, &$filter, &$result, &$to), "jotun_db_tools_QueryBuilder_6"), 'execute'), null);
		return $result;
	}
	...
	function __toString() { return 'jotun.db.tools.QueryBuilder'; }
}
function jotun_db_tools_QueryBuilder_0(&$dataset, &$i, &$q, &$r, $p, $v) {
	{
		$r[$i] = $p;
		$q[$i] = "?";
		$i = $i + 1;
...
function jotun_db_tools_QueryBuilder_1(&$dataset, &$q, $p, $v) {
	{
		$q[$q->length] = _hx_string_or_null($p) . "=?";
		$dataset[$dataset->length] = $v;
	}
}
function jotun_db_tools_QueryBuilder_2(&$r, $p, $v) {
	{
		$r1 = $r->length;
		$tmp = null;
		if($v !== null) {
...
function jotun_db_tools_QueryBuilder_3(&$_gthis, &$joiner, &$props, &$r, $v) {
	{
...
function jotun_db_tools_QueryBuilder_4(&$_gthis, &$joiner, &$props, &$r, $p, $v1) {
	{
		if(Std::is($v1, _hx_qtype("jotun.db.Clause"))) {
			$v2 = $v1->joiner();
...
function jotun_db_tools_QueryBuilder_5(&$props, $p1, $v3) {
	{
		$props[_hx_field($props, "length")] = $v3;
	}
}
function jotun_db_tools_QueryBuilder_6(&$_gthis, &$filter, &$result, &$to, $v) {
	{
		if($filter !== null) {
