...
class Image {
	...
	public function crop ($x, $y, $width, $height) {
		...
		if ($this->isValid()) {
			...
			$tx = $x + $width;
			#src/jotun/php/file/Image.hx:146: characters 4-28
			$ty = $y + $height;
	...
	public function isOutBounds ($width, $height) {
		#src/jotun/php/file/Image.hx:186: characters 10-52
		if ($this->width <= $width) {
			#src/jotun/php/file/Image.hx:186: characters 32-52
	...
	public function open ($file) {
		...
		if ($file !== null) {
			...
			if ($isFile) {
				...
				#src/jotun/php/file/Image.hx:90: characters 5-54
				$this->width = imagesx($img);
				#src/jotun/php/file/Image.hx:91: characters 5-55
