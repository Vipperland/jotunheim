...
class CommandCore implements ICommandCore {
	...
	public function bind ($parameters) {
		#src/jotun/php/db/tools/CommandCore.hx:63: lines 63-73
		$_gthis = $this;
		#src/jotun/php/db/tools/CommandCore.hx:64: characters 3-27
		$this->_parameters = $parameters;
		#src/jotun/php/db/tools/CommandCore.hx:65: lines 65-72
		if ($this->statement !== null) {
			#src/jotun/php/db/tools/CommandCore.hx:66: lines 66-71
			Dice::All($parameters, function ($p, $v) use (&$_gthis) {
				#src/jotun/php/db/tools/CommandCore.hx:67: lines 67-69
				if (($v !== null) && !is_string($v) && !(is_float($v) || is_int($v)) && !Boot::isOfType($v, Boot::getClass('Int')) && !is_bool($v)) {
					#src/jotun/php/db/tools/CommandCore.hx:68: characters 10-27
					$v = Json::phpJsonEncode($v, null, null);
				}
				#src/jotun/php/db/tools/CommandCore.hx:70: characters 5-45
	 ...
	 */
	public function log () {
		#src/jotun/php/db/tools/CommandCore.hx:75: lines 75-89
		$_gthis = $this;
		#src/jotun/php/db/tools/CommandCore.hx:76: characters 3-44
		$r = HxString::split($this->_query, "?");
		#src/jotun/php/db/tools/CommandCore.hx:77: lines 77-87
		if ($this->_parameters !== null) {
			#src/jotun/php/db/tools/CommandCore.hx:78: lines 78-86
			Dice::All($r, function ($p, $v) use (&$r, &$_gthis) {
				#src/jotun/php/db/tools/CommandCore.hx:79: lines 79-85
				if ($p < $_gthis->_parameters->length) {
					#src/jotun/php/db/tools/CommandCore.hx:80: characters 6-37
					$e = ($_gthis->_parameters->arr[$p] ?? null);
					#src/jotun/php/db/tools/CommandCore.hx:81: lines 81-83
					if (is_string($e)) {
						#src/jotun/php/db/tools/CommandCore.hx:82: characters 7-24
						$e = "\"" . \Std::string($e) . "\"";
					}
					#src/jotun/php/db/tools/CommandCore.hx:84: characters 6-18
					$r->offsetSet($p, ($v??'null') . \Std::string($e));
				}
			});
		}
		#src/jotun/php/db/tools/CommandCore.hx:88: characters 3-20
		return $r->join("");
	}
	...
	public function query () {
		#src/jotun/php/db/tools/CommandCore.hx:92: characters 3-16
		return $this->_query;
	}
}
