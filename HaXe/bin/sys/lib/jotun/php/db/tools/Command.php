	...
	public function execute ($handler = null, $type = null, $parameters = null) {
		...
		if ($this->statement !== null) {
			...
			try {
				...
				if (!$this->success) {
					#src/jotun/php/db/tools/Command.hx:26: characters 6-91
					$_this = $this->get_errors();
					#src/jotun/php/db/tools/Command.hx:26: characters 28-49
				...
				if (is_string($e)) {
					#src/jotun/php/db/tools/Command.hx:31: characters 6-34
					$_this = $this->get_errors();
					$x = new Error(0, $e);
					$_this->arr[$_this->length++] = $x;
				} else {
					#src/jotun/php/db/tools/Command.hx:33: characters 6-57
					$_this = $this->get_errors();
					#src/jotun/php/db/tools/Command.hx:33: characters 28-39
					$x = $e->getCode();
					#src/jotun/php/db/tools/Command.hx:33: characters 6-57
			...
			#src/jotun/php/db/tools/Command.hx:40: characters 4-72
			$_this = $this->get_errors();
