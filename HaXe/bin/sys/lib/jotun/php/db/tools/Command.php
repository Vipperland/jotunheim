...
class Command implements ICommand {
	 ...
	 */
	public function log () {
		#src/jotun/php/db/tools/Command.hx:101: lines 101-113
		$_gthis = $this;
		#src/jotun/php/db/tools/Command.hx:102: characters 3-44
		$r = HxString::split($this->_query, "?");
		#src/jotun/php/db/tools/Command.hx:103: lines 103-111
		Dice::All($r, function ($p, $v) use (&$r, &$_gthis) {
			#src/jotun/php/db/tools/Command.hx:104: lines 104-110
			if ($p < $_gthis->_parameters->length) {
				#src/jotun/php/db/tools/Command.hx:105: characters 5-36
				$e = ($_gthis->_parameters->arr[$p] ?? null);
				#src/jotun/php/db/tools/Command.hx:106: lines 106-108
				if (is_string($e)) {
					#src/jotun/php/db/tools/Command.hx:107: characters 6-23
					$e = "\"" . \Std::string($e) . "\"";
				}
				#src/jotun/php/db/tools/Command.hx:109: characters 5-17
				$r->offsetSet($p, ($v??'null') . \Std::string($e));
			}
		});
		#src/jotun/php/db/tools/Command.hx:112: characters 3-20
		return $r->join("");
	}
	...
	public function query () {
		#src/jotun/php/db/tools/Command.hx:116: characters 3-16
		return $this->_query;
	}
}
