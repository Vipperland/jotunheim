...
class Utils {
	...
	public static function isFunction ($o) {
		#src/jotun/tools/Utils.hx:567: characters 4-54
	...
	public static function range ($value, ...$values) {
		#src/jotun/tools/Utils.hx:549: characters 3-17
		$r = 0;
		#src/jotun/tools/Utils.hx:550: characters 13-17
		$_g = 0;
		#src/jotun/tools/Utils.hx:550: characters 17-30
		$_g1 = \count($values);
		#src/jotun/tools/Utils.hx:550: lines 550-556
		while ($_g < $_g1) {
			#src/jotun/tools/Utils.hx:550: characters 13-30
			$i = $_g++;
			#src/jotun/tools/Utils.hx:551: lines 551-555
			if ($value > $values[$i]) {
				#src/jotun/tools/Utils.hx:552: characters 5-8
				++$r;
			} else {
				#src/jotun/tools/Utils.hx:554: characters 5-10
				break;
			}
		}
		#src/jotun/tools/Utils.hx:557: characters 3-11
		return $r;
	}
	...
	public static function toFixed ($n, $i, $s = ".", $t = "") {
		#src/jotun/tools/Utils.hx:563: characters 4-77
		if ($s === null) {
			$s = ".";
		}
		if ($t === null) {
