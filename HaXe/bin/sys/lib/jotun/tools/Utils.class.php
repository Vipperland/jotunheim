...
class jotun_tools_Utils {
	public function __construct(){}
	static function getMin($values, $filter = null) {
		$r = null;
		jotun_utils_Dice::Values($values, array(new _hx_lambda(array(&$filter, &$r), "jotun_tools_Utils_0"), 'execute'), null);
		return $r;
	}
	static function getMax($values, $filter = null) {
		$r = null;
		jotun_utils_Dice::Values($values, array(new _hx_lambda(array(&$filter, &$r), "jotun_tools_Utils_1"), 'execute'), null);
		return $r;
	}
	static function getQueryParams($value) {
		...
		jotun_utils_Dice::Values(_hx_explode("&", $value), array(new _hx_lambda(array(&$params), "jotun_tools_Utils_2"), 'execute'), null);
		return $params;
	}
	static function clearArray($path, $filter = null) {
		$copy = (new _hx_array(array()));
		jotun_utils_Dice::Values($path, array(new _hx_lambda(array(&$copy, &$filter), "jotun_tools_Utils_3"), 'execute'), null);
		return $copy;
	}
	...
	static function _sruFy($o, $i, $b) {
		...
		jotun_utils_Dice::All($o, array(new _hx_lambda(array(&$b, &$i), "jotun_tools_Utils_4"), 'execute'), null);
		return $b;
	}
	...
	static function isValidAll($o) {
		$q = jotun_utils_Dice::Values($o, array(new _hx_lambda(array(), "jotun_tools_Utils_5"), 'execute'), null);
		return $q->completed;
	}
	static function getValidOne($o, $alt) {
		if(jotun_tools_Utils::isValid($o, null)) {
			return $o;
		} else {
			return $alt;
		}
	...
	static function paramsOf($o) {
		...
		jotun_utils_Dice::All($o, array(new _hx_lambda(array(&$r), "jotun_tools_Utils_6"), 'execute'), null);
		return $r->join("&");
	}
	function __toString() { return 'jotun.tools.Utils'; }
}
function jotun_tools_Utils_0(&$filter, &$r, $i) {
	{
		$tmp = null;
		if($filter !== null) {
...
function jotun_tools_Utils_1(&$filter, &$r, $i) {
	{
		$tmp = null;
		if($filter !== null) {
			$tmp = call_user_func_array($filter, array($i));
...
function jotun_tools_Utils_2(&$params, $v) {
	{
		$data = _hx_explode("=", $v);
		if($data->length > 1) {
...
function jotun_tools_Utils_3(&$copy, &$filter, $v) {
	{
		$tmp = null;
		$tmp1 = null;
		if($v !== null) {
...
function jotun_tools_Utils_4(&$b, &$i, $p, $v) {
	{
		if($v === null) {
				...
				if(Std::is($v, _hx_qtype("Bool"))) {
					...
					if($tmp) {
						...
						if(Std::is($v, _hx_qtype("Array"))) {
							...
							$b9 = _hx_string_or_null($b8) . _hx_string_or_null(jotun_tools_Utils::_sruFy($v, $i, ""));
							...
							$b11 = _hx_string_or_null($b10) . _hx_string_or_null(jotun_tools_Utils::_sruFy($v, $i, ""));
...
function jotun_tools_Utils_5($v) {
	{
		return !jotun_tools_Utils::isValid($v, null);
	}
}
function jotun_tools_Utils_6(&$r, $p, $v) {
	{
