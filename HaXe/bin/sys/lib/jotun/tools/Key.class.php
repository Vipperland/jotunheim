...
class jotun_tools_Key {
	...
	static function COUNTER($id = null) {
		...
		$v = 0;
		$o = jotun_tools_Key::$_cts;
		if(!_hx_has_field($o, $id)) {
			$o1 = jotun_tools_Key::$_cts;
			$o1->{$id} = 0;
		} else {
			$v = Reflect::field(jotun_tools_Key::$_cts, $id);
			{
				$o2 = jotun_tools_Key::$_cts;
				$o2->{$id} = $v + 1;
			}
		}
		return $v;
	...
	static function UUID() {
		...
		jotun_tools_Key::$_last_uuid = jotun_serial_IOTools::md5Encode(_hx_string_or_null($tmp) . _hx_string_or_null(jotun_tools_Key::GEN(null, null, null)), null);
		return jotun_tools_Key::$_last_uuid;
	}
	...
	function __toString() { return 'jotun.tools.Key'; }
}
jotun_tools_Key::$_cts = _hx_anonymous(array("global" => 0));
