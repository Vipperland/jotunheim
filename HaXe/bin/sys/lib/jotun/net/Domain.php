...
class Domain implements IDomain {
	...
	public function _getJsonInput () {
		#src/jotun/net/Domain.hx:129: characters 4-33
		$data = $this->getInput();
		#src/jotun/net/Domain.hx:130: characters 4-53
		if (($data === null) || (mb_strlen($data) === 0)) {
			#src/jotun/net/Domain.hx:130: characters 42-53
			return null;
		}
		#src/jotun/net/Domain.hx:131: characters 4-48
		if (\mb_substr($data, 0, 4) === "----") {
			#src/jotun/net/Domain.hx:131: characters 37-48
			return null;
		}
		#src/jotun/net/Domain.hx:132: lines 132-136
		try {
			#src/jotun/net/Domain.hx:133: characters 5-28
			return Json::phpJsonDecode($data);
		} catch(\Throwable $_g) {
			#src/jotun/net/Domain.hx:135: characters 5-16
			return null;
		}
	}
				...
				if (HxString::indexOf($param, "Content-Type:") === -1) {
					...
					if ((mb_strlen($param) > 0) && (mb_strlen($value) > 0) && ($value !== "null")) {
						...
						if (HxString::indexOf($param, "[]") === -1) {
							#src/jotun/net/Domain.hx:184: characters 9-31
							\Reflect::setField($data, $param, $value);
						} else {
							#src/jotun/net/Domain.hx:186: lines 186-188
							if (!\Reflect::hasField($data, $param)) {
								#src/jotun/net/Domain.hx:187: characters 10-29
								$value1 = new \Array_hx();
								\Reflect::setField($data, $param, $value1);
							}
							#src/jotun/net/Domain.hx:189: characters 9-53
							$_this = \Reflect::field($data, $param);
	...
	public function _parseURI () {
		#src/jotun/net/Domain.hx:70: characters 4-76
		$this->server = Lib::objectOfAssociativeArray($_SERVER);
		#src/jotun/net/Domain.hx:71: characters 4-29
		...
		#src/jotun/net/Domain.hx:78: characters 4-41
		$_ct = $this->server->CONTENT_TYPE;
		#src/jotun/net/Domain.hx:79: characters 4-70
		if (($_ct === null) || (mb_strlen($_ct) === 0)) {
			#src/jotun/net/Domain.hx:79: characters 40-70
			$_ct = $this->server->HTTP_CONTENT_TYPE;
		}
		#src/jotun/net/Domain.hx:80: lines 80-84
		if ($_ct !== null) {
			#src/jotun/net/Domain.hx:81: lines 81-83
			if (HxString::indexOf($_ct, "application/json") !== -1) {
				#src/jotun/net/Domain.hx:82: characters 6-45
				$this->input = new DataSource($this->_getJsonInput());
			}
		}
		#src/jotun/net/Domain.hx:86: characters 4-47
		Jotun::$params = new DataSource($this->_getParams());
		#src/jotun/net/Domain.hx:88: lines 88-92
		if ($boundary !== null) {
			#src/jotun/net/Domain.hx:89: characters 5-39
			\Reflect::deleteField(Jotun::$params->data, $boundary);
			#src/jotun/net/Domain.hx:90: characters 5-41
			$boundary = (HxString::split($boundary, "\x0D\x0A")->arr[0] ?? null);
			#src/jotun/net/Domain.hx:91: characters 5-45
			$this->_getRawData($boundary, Jotun::$params->data);
		}
		#src/jotun/net/Domain.hx:93: characters 4-39
	...
	public function getRequestMethod () {
		#src/jotun/net/Domain.hx:121: characters 11-46
	...
	public function isRequestMethod ($q) {
		#src/jotun/net/Domain.hx:125: characters 4-48
