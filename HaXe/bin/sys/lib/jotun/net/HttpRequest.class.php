...
class jotun_net_HttpRequest {
	public function __construct($url) {
		if(!isset($this->onData)) $this->onData = array(new _hx_lambda(array(&$this), "jotun_net_HttpRequest_0"), 'execute');
		if(!isset($this->onError)) $this->onError = array(new _hx_lambda(array(&$this), "jotun_net_HttpRequest_1"), 'execute');
		if(!isset($this->onStatus)) $this->onStatus = array(new _hx_lambda(array(&$this), "jotun_net_HttpRequest_2"), 'execute');
	...
	public function setHeader($header, $value) {
		$this->headers = Lambda::filter($this->headers, array(new _hx_lambda(array(&$header), "jotun_net_HttpRequest_3"), 'execute'));
	...
	public function setParameter($param, $value) {
		$this->params = Lambda::filter($this->params, array(new _hx_lambda(array(&$param), "jotun_net_HttpRequest_4"), 'execute'));
		$this->params->push(_hx_anonymous(array("param" => $param, "value" => $value)));
		return $this;
	}
	public function addParameter($param, $value) {
		$tmp = $this->params;
		$tmp->push(_hx_anonymous(array("param" => $param, "value" => Std::string($value))));
		return $this;
	}
	public function request($post = null) {
		...
		$err = false;
		$this->onError = array(new _hx_lambda(array(&$_gthis, &$err, &$me1, &$old, &$output), "jotun_net_HttpRequest_5"), 'execute');
	...
	public function customRequest($post, $api, $sock = null, $method = null) {
		...
		if(_hx_field(_hx_qtype("jotun.net.HttpRequest"), "PROXY") !== null) {
			$b1->add("http://");
			$b1->add($host);
			if($port !== 80) {
				$b1->add(":");
		...
		if($this->postData !== null) {
			...
			if($tmp1) {
				$tmp2 = null;
				if(!$multipart) {
					$tmp2 = !Lambda::exists($this->headers, array(new _hx_lambda(array(), "jotun_net_HttpRequest_6"), 'execute'));
				} else {
					$tmp2 = true;
				}
				if($tmp2) {
		...
		try {
			if(_hx_field(_hx_qtype("jotun.net.HttpRequest"), "PROXY") !== null) {
				$sock->connect(new sys_net_Host(jotun_net_HttpRequest::$PROXY->host), jotun_net_HttpRequest::$PROXY->port);
			} else {
		...
		if($size === null) {
			...
			try {
				while($size > 0) {
					...
					$len2 = $sock->input->readBytes($buf, 0, $len1);
					if($chunked) {
	...
	static function requestUrl($url) {
		$h = new jotun_net_HttpRequest($url);
		$r = null;
		$h->onData = array(new _hx_lambda(array(&$r), "jotun_net_HttpRequest_7"), 'execute');
		$h->onError = array(new _hx_lambda(array(), "jotun_net_HttpRequest_8"), 'execute');
		$h->request(false);
		return $r;
	}
	function __toString() { return 'jotun.net.HttpRequest'; }
}
function jotun_net_HttpRequest_0(&$__hx__this, $data) {
	{
	}
}
function jotun_net_HttpRequest_1(&$__hx__this, $msg) {
	{
	}
}
function jotun_net_HttpRequest_2(&$__hx__this, $status) {
	{
	}
}
function jotun_net_HttpRequest_3(&$header, $h) {
	{
		return $h->header !== $header;
	}
}
function jotun_net_HttpRequest_4(&$param, $p) {
	{
		return $p->param !== $param;
	}
}
function jotun_net_HttpRequest_5(&$_gthis, &$err, &$me1, &$old, &$output, $e) {
	{
...
function jotun_net_HttpRequest_6($h) {
	{
		return $h->header === "Content-Type";
	}
}
function jotun_net_HttpRequest_7(&$r, $d) {
	{
		$r = $d;
	}
}
function jotun_net_HttpRequest_8($e) {
	{
