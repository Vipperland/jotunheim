...
class DomainAccessCore extends DomainZoneCore {
	...
	public function getServices () {
		#src+extras/gateway/jotun/gateway/domain/DomainAccessCore.hx:48: characters 3-75
		$service = Utils::getValidOne(Boot::dynamicField(Jotun::$domain->params, 'service'), "");
		#src+extras/gateway/jotun/gateway/domain/DomainAccessCore.hx:49: characters 3-48
