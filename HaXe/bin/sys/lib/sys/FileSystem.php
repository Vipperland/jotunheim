...
class FileSystem {
	...
	public static function isDirectory ($path) {
		#D:\Devland\Tools\SDK\Haxe\4.3.7\haxe\std/php/_std/sys/FileSystem.hx:94: characters 3-36
		\clearstatcache(true, $path);
		#D:\Devland\Tools\SDK\Haxe\4.3.7\haxe\std/php/_std/sys/FileSystem.hx:95: characters 3-29
		return \is_dir($path);
	}
}
