...
class File {
	...
	public static function getContent ($path) {
		#D:\Devland\Tools\SDK\Haxe\4.3.7\haxe\std/php/_std/sys/io/File.hx:30: characters 3-33
	...
	public static function write ($path, $binary = true) {
		#D:\Devland\Tools\SDK\Haxe\4.3.7\haxe\std/php/_std/sys/io/File.hx:52: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
