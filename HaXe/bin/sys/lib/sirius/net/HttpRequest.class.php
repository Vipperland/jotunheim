...
class sirius_net_HttpRequest {
	public function __construct($url) {
		if(!isset($this->onData)) $this->onData = array(new _hx_lambda(array(&$this), "sirius_net_HttpRequest_0"), 'execute');
		if(!isset($this->onError)) $this->onError = array(new _hx_lambda(array(&$this), "sirius_net_HttpRequest_1"), 'execute');
		if(!isset($this->onStatus)) $this->onStatus = array(new _hx_lambda(array(&$this), "sirius_net_HttpRequest_2"), 'execute');
	...
	public function setHeader($header, $value) {
		$this->headers = Lambda::filter($this->headers, array(new _hx_lambda(array(&$header), "sirius_net_HttpRequest_3"), 'execute'));
	...
	public function setParameter($param, $value) {
		$this->params = Lambda::filter($this->params, array(new _hx_lambda(array(&$param), "sirius_net_HttpRequest_4"), 'execute'));
	...
	public function request($post = null) {
		...
		$err = false;
		$this->onError = array(new _hx_lambda(array(&$_gthis, &$err, &$me1, &$old, &$output), "sirius_net_HttpRequest_5"), 'execute');
	...
	public function customRequest($post, $api, $sock = null, $method = null) {
		...
		if($this->postData !== null) {
			...
			if($tmp1) {
				$tmp2 = null;
				if(!$multipart) {
					$tmp2 = !Lambda::exists($this->headers, array(new _hx_lambda(array(), "sirius_net_HttpRequest_6"), 'execute'));
				} else {
					$tmp2 = true;
				}
				if($tmp2) {
	...
	static function requestUrl($url) {
		...
		$r = null;
		$h->onData = array(new _hx_lambda(array(&$r), "sirius_net_HttpRequest_7"), 'execute');
		$h->onError = array(new _hx_lambda(array(), "sirius_net_HttpRequest_8"), 'execute');
		$h->request(false);
		return $r;
	}
	function __toString() { return 'sirius.net.HttpRequest'; }
}
function sirius_net_HttpRequest_0(&$__hx__this, $data) {
	{
	}
}
function sirius_net_HttpRequest_1(&$__hx__this, $msg) {
	{
	}
}
function sirius_net_HttpRequest_2(&$__hx__this, $status) {
	{
	}
}
function sirius_net_HttpRequest_3(&$header, $h) {
	{
		return $h->header !== $header;
	}
}
function sirius_net_HttpRequest_4(&$param, $p) {
	{
		return $p->param !== $param;
	}
}
function sirius_net_HttpRequest_5(&$_gthis, &$err, &$me1, &$old, &$output, $e) {
	{
...
function sirius_net_HttpRequest_6($h) {
	{
		return $h->header === "Content-Type";
	}
}
function sirius_net_HttpRequest_7(&$r, $d) {
	{
		$r = $d;
	}
}
function sirius_net_HttpRequest_8($e) {
	{
