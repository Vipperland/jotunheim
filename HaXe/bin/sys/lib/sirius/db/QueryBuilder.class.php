...
class sirius_db_QueryBuilder implements sirius_db_IQueryBuilder{
	public function __construct($gate) {
		if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::new");
	...
	public function _conditions($obj, $props, $joiner) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_conditions");
		$__hx__spos = $GLOBALS['%s']->length;
		$_g = $this;
		...
		if(Std::is($obj, _hx_qtype("sirius.db.Clause"))) {
			sirius_utils_Dice::Values($obj->conditions, array(new _hx_lambda(array(&$_g, &$b, &$joiner, &$obj, &$props, &$r, &$s), "sirius_db_QueryBuilder_0"), 'execute'), null);
			$s = $obj->joiner();
		} else {
			if(Std::is($obj, _hx_qtype("Array"))) {
				sirius_utils_Dice::All($obj, array(new _hx_lambda(array(&$_g, &$b, &$joiner, &$obj, &$props, &$r, &$s), "sirius_db_QueryBuilder_1"), 'execute'), null);
			} else {
	...
	public function _assembleBody($clause = null, $parameters = null, $order = null, $limit = null) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_assembleBody");
		$__hx__spos = $GLOBALS['%s']->length;
		$q = "";
		if($clause !== null) {
	...
	public function create($table, $clause = null, $parameters = null, $order = null, $limit = null) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::create");
		$__hx__spos = $GLOBALS['%s']->length;
		{
	...
	public function find($fields, $table, $clause = null, $order = null, $limit = null) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::find");
		$__hx__spos = $GLOBALS['%s']->length;
	...
	public function update($table, $clause = null, $parameters = null, $order = null, $limit = null) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::update");
		$__hx__spos = $GLOBALS['%s']->length;
		if($parameters === null) {
			$parameters = _hx_anonymous(array());
		}
	...
	public function delete($table, $clause = null, $order = null, $limit = null) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::delete");
		$__hx__spos = $GLOBALS['%s']->length;
		$parameters = _hx_anonymous(array());
		{
	...
	public function _insert($parameters) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_insert");
		$__hx__spos = $GLOBALS['%s']->length;
		$q = (new _hx_array(array()));
		sirius_utils_Dice::Params($parameters, array(new _hx_lambda(array(&$parameters, &$q), "sirius_db_QueryBuilder_2"), 'execute'), null);
		{
	...
	public function _updateSet($parameters) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_updateSet");
		$__hx__spos = $GLOBALS['%s']->length;
		$q = (new _hx_array(array()));
		sirius_utils_Dice::Params($parameters, array(new _hx_lambda(array(&$parameters, &$q), "sirius_db_QueryBuilder_3"), 'execute'), null);
		{
			$tmp = $q->join(",");
			$GLOBALS['%s']->pop();
			return $tmp;
	...
	public function _order($obj) {
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_order");
		$__hx__spos = $GLOBALS['%s']->length;
		$r = (new _hx_array(array()));
		sirius_utils_Dice::All($obj, array(new _hx_lambda(array(&$obj, &$r), "sirius_db_QueryBuilder_4"), 'execute'), null);
		{
			$tmp = $r->join(",");
			$GLOBALS['%s']->pop();
			return $tmp;
...
function sirius_db_QueryBuilder_0(&$_g, &$b, &$joiner, &$obj, &$props, &$r, &$s, $v) {
	{
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_conditions@26");
		$__hx__spos2 = $GLOBALS['%s']->length;
		$r[$r->length] = $_g->_conditions($v, $props, $joiner);
		$GLOBALS['%s']->pop();
	}
}
function sirius_db_QueryBuilder_1(&$_g, &$b, &$joiner, &$obj, &$props, &$r, &$s, $p, $v1) {
	{
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_conditions@31");
		$__hx__spos2 = $GLOBALS['%s']->length;
...
function sirius_db_QueryBuilder_2(&$parameters, &$q, $p) {
	{
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_insert@84");
		$__hx__spos2 = $GLOBALS['%s']->length;
		$q[$q->length] = $p;
		$GLOBALS['%s']->pop();
	}
}
function sirius_db_QueryBuilder_3(&$parameters, &$q, $p) {
	{
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_updateSet@91");
		$__hx__spos2 = $GLOBALS['%s']->length;
		$q[$q->length] = _hx_string_or_null($p) . "=:" . _hx_string_or_null($p);
		$GLOBALS['%s']->pop();
	}
}
function sirius_db_QueryBuilder_4(&$obj, &$r, $p, $v) {
	{
		$GLOBALS['%s']->push("sirius.db.QueryBuilder::_order@98");
		$__hx__spos2 = $GLOBALS['%s']->length;
		$r[$r->length] = _hx_string_or_null($p) . _hx_string_or_null((sirius_db_QueryBuilder_5($__hx__this, $obj, $p, $r, $v)));
		$GLOBALS['%s']->pop();
	}
}
function sirius_db_QueryBuilder_5(&$__hx__this, &$obj, &$p, &$r, &$v) {
	if($v !== null) {
		return " " . Std::string($v);
	} else {
		return "";
