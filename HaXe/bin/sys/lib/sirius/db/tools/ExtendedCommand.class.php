...
class sirius_db_tools_ExtendedCommand implements sirius_db_tools_IExtendedCommand{
		...
		if($this->conn !== null) {
			...
			try {
				...
				if($statement2 !== null) {
					...
					$tmp[$tmp1] = new sirius_errors_Error($tmp2, haxe_Json::phpJsonEncode($statement2->errorInfo(), null, null), null);
				}
	...
	public function find($param, $values, $limit = null) {
		...
		sirius_utils_Dice::Values($this->result, array(new _hx_lambda(array(&$filter, &$limit, &$param, &$values), "sirius_db_tools_ExtendedCommand_0"), 'execute'), null);
		return $filter;
	}
	...
	public function log() {
		...
		sirius_utils_Dice::All($r, array(new _hx_lambda(array(&$_gthis, &$r), "sirius_db_tools_ExtendedCommand_1"), 'execute'), null);
		return $r->join("");
	}
	...
	function __toString() { return 'sirius.db.tools.ExtendedCommand'; }
}
function sirius_db_tools_ExtendedCommand_0(&$filter, &$limit, &$param, &$values, $v) {
	{
...
function sirius_db_tools_ExtendedCommand_1(&$_gthis, &$r, $p, $v) {
	{
