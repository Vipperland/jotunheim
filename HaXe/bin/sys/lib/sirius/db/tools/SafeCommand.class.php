...
class sirius_db_tools_SafeCommand implements sirius_db_tools_ICommand{
	...
	public function bind($parameters) {
		...
		if($this->statement !== null) {
			...
			sirius_utils_Dice::All($parameters, array(new _hx_lambda(array(&$_gthis), "sirius_db_tools_SafeCommand_0"), 'execute'), null);
		}
		return $this;
	}
	...
	public function find($param, $values, $limit = null) {
		...
		sirius_utils_Dice::Values($this->result, array(new _hx_lambda(array(&$filter, &$limit, &$param, &$values), "sirius_db_tools_SafeCommand_1"), 'execute'), null);
		return $filter;
	}
	...
	public function log() {
		...
		sirius_utils_Dice::All($r, array(new _hx_lambda(array(&$_gthis, &$r), "sirius_db_tools_SafeCommand_2"), 'execute'), null);
		return $r->join("");
	}
	...
	function __toString() { return 'sirius.db.tools.SafeCommand'; }
}
function sirius_db_tools_SafeCommand_0(&$_gthis, $p, $v) {
	{
...
function sirius_db_tools_SafeCommand_1(&$filter, &$limit, &$param, &$values, $v) {
	{
...
function sirius_db_tools_SafeCommand_2(&$_gthis, &$r, $p, $v) {
	{
