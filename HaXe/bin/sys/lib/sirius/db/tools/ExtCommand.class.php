...
class sirius_db_tools_ExtCommand implements sirius_db_tools_IExtCommand{
	...
	public function find($param, $values, $limit = null) {
		...
		sirius_utils_Dice::Values($this->result, array(new _hx_lambda(array(&$filter, &$limit, &$param, &$values), "sirius_db_tools_ExtCommand_0"), 'execute'), null);
		return $filter;
	}
	...
	public function log() {
		...
		sirius_utils_Dice::All($r, array(new _hx_lambda(array(&$_gthis, &$r), "sirius_db_tools_ExtCommand_1"), 'execute'), null);
		return $r->join("");
	}
	...
	function __toString() { return 'sirius.db.tools.ExtCommand'; }
}
function sirius_db_tools_ExtCommand_0(&$filter, &$limit, &$param, &$values, $v) {
	{
...
function sirius_db_tools_ExtCommand_1(&$_gthis, &$r, $p, $v) {
	{
