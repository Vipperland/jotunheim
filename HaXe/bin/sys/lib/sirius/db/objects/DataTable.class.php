...
class sirius_db_objects_DataTable implements sirius_db_objects_IDataTable{
	...
	public function clear($paramaters) {
		...
		sirius_utils_Dice::All($paramaters, array(new _hx_lambda(array(&$desc, &$paramaters), "sirius_db_objects_DataTable_1"), 'execute'), null);
		return $paramaters;
	}
...
function sirius_db_objects_DataTable_1(&$desc, &$paramaters, $p, $v) {
	{
