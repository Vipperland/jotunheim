...
class sirius_php_Sirius {
	...
	static function log($q, $level = null, $type = null) {
		...
		if(sirius_php_Sirius_0($level, $q, $type)) {
			...
			haxe_Log::trace(_hx_string_or_null($t) . Std::string($q), _hx_anonymous(array("fileName" => "Sirius.hx", "lineNumber" => 44, "className" => "sirius.php.Sirius", "methodName" => "log")));
		}
	}
...
sirius_php_Sirius::$cache = new php_data_Cache();
