...
class sirius_php_db_Command {
	...
	public function bind($arguments) {
		...
		sirius_utils_Dice::All($arguments, array(new _hx_lambda(array(&$_g, &$arguments, &$isArray), "sirius_php_db_Command_0"), 'execute'), null);
		return $this;
	}
...
function sirius_php_db_Command_0(&$_g, &$arguments, &$isArray, $p, $v) {
	{
		if($isArray) {
