...
jotun_dom_Display.prototype = $extend(jotun_objects_Query.prototype,{
	...
	,colorTransform: function(r,g,b,a) {
		...
		var name = "auto-" + (r == null ? "null" : Std.string(UInt.toFloat(r))) + "x" + (g == null ? "null" : Std.string(UInt.toFloat(g))) + "x" + (b == null ? "null" : Std.string(UInt.toFloat(b))) + "x" + (a == null ? "null" : Std.string(UInt.toFloat(a)));
		jotun_css_XCode.createFilter(name,UInt.toFloat(r) / UInt.toFloat(255),UInt.toFloat(g) / UInt.toFloat(255),UInt.toFloat(b) / UInt.toFloat(255),UInt.toFloat(a) / UInt.toFloat(255));
...
jotun_transitions_Ease.fromString = function(q) {
	var q = [];
	var C = Reflect.field(jotun_transitions_Ease,q[0]);
	var e = null;
	if(C != null) {
		if(q.length > 1) {
			e = Reflect.field(C,q[1]);
		}
		if(e == null) {
			e = C.X;
		}
...
jotun_net_Loader.prototype = {
	...
	,module: function(file,data,handler,progress) {
		...
		r.onError = function(d) {
			_gthis._changed(file,"error",d,r);
			if(handler != null) {
...
jotun_modules_ModLib.prototype = {
				...
				if(p > 0) {
					...
					if(i != -1) {
						...
						if(mod.require != null) {
							...
							jotun_utils_Dice.Values(dependencies,function(v) {
								var set = Reflect.field(jotun_modules_ModLib.CACHE,v.toLowerCase());
								if(set == null) {
									jotun_Jotun.log("\t\tModLib => REQUIRED " + v,2);
								} else {
	...
	,getObj: function(name,data) {
		...
		if(val != null) {
			try {
				...
				haxe_Log.trace("Parsing error for MOD:[" + name + "]",{ fileName : "src/jotun/modules/ModLib.hx", lineNumber : 234, className : "jotun.modules.ModLib", methodName : "getObj"});
			}
		}
		return null;
	}
	...
	,build: function(module,data,each) {
		...
		if(each != null && ((data) instanceof Array)) {
			d = new jotun_dom_Div();
			jotun_utils_Dice.Values(data,function(v) {
				v = new jotun_dom_Display().writeHtml(_gthis.get(module,v));
				v = each(v);
				if(v != null && js_Boot.__implements(v,jotun_dom_IDisplay)) {
