...
var jotun_dom_Display = $hx_exports["J_Display"] = function(q,t) {
	if(q == null) {
...
var jotun_dom_Style = $hx_exports["J_Style"] = function(q) {
	if(q == null) {
...
var jotun_dom_Script = $hx_exports["J_Script"] = function(q) {
	if(q == null) {
...
var jotun_gaming_actions_Resolution = function(type,data,param) {
	...
	if(data.then != null) {
		this.then = new jotun_gaming_actions_Events(this._type + ":then",data.then);
	}
	if(data.fail != null) {
		this.fail = new jotun_gaming_actions_Events(this._type + ":fail",data.fail);
	}
	this.id = data.id;
};
...
jotun_gaming_actions_ActionQuery.prototype = $extend(jotun_objects_Query.prototype,{
	...
	,call: function(id) {
		var action = jotun_gaming_actions_EventController.loadAction(id);
		if(action != null) {
...
var jotun_gaming_actions_EventContext = function(name,data,provider,controller,debug) {
	this.origin = data;
	this.name = name;
	this.debug = debug;
	this.ended = false;
...
jotun_gaming_actions_EventContext.__name__ = "jotun.gaming.actions.EventContext";
jotun_gaming_actions_EventContext.prototype = {
	debug: null
	,ended: null
	,name: null
	,log: null
	...
	,release: function(resolution,result) {
		...
		if(chain != null) {
			var temp = jotun_gaming_actions_Events.patch({ _onActionReleased : chain})["_onActionReleased"];
	...
	,__class__: jotun_gaming_actions_EventContext
};
...
var jotun_gaming_actions_IEventCounter = function() { };
jotun_gaming_actions_IEventCounter.__name__ = "jotun.gaming.actions.IEventCounter";
jotun_gaming_actions_IEventCounter.__isInterface__ = true;
jotun_gaming_actions_IEventCounter.prototype = {
	query: null
	,count: null
	,queries: null
	,__class__: jotun_gaming_actions_IEventCounter
};
var jotun_gaming_actions_IEventContextAction = function() { };
jotun_gaming_actions_IEventContextAction.__name__ = "jotun.gaming.actions.IEventContextAction";
jotun_gaming_actions_IEventContextAction.__isInterface__ = true;
jotun_gaming_actions_IEventContextAction.__interfaces__ = [jotun_gaming_actions_IEventCounter];
jotun_gaming_actions_IEventContextAction.prototype = {
	target: null
	,__class__: jotun_gaming_actions_IEventContextAction
};
var jotun_gaming_actions_IEventContextRequirement = function() { };
jotun_gaming_actions_IEventContextRequirement.__name__ = "jotun.gaming.actions.IEventContextRequirement";
jotun_gaming_actions_IEventContextRequirement.__isInterface__ = true;
jotun_gaming_actions_IEventContextRequirement.__interfaces__ = [jotun_gaming_actions_IEventCounter];
jotun_gaming_actions_IEventContextRequirement.prototype = {
	target: null
	,__class__: jotun_gaming_actions_IEventContextRequirement
};
...
var jotun_gaming_actions_EventController = $hx_exports["J_EventController"] = function(data,debug,validate,priority) {
	this._chain = [];
	this._index = 0;
	jotun_gaming_actions_EventController._debug = debug == true;
	this.events = jotun_gaming_actions_Events.patch(data,validate,priority);
};
jotun_gaming_actions_EventController.__name__ = "jotun.gaming.actions.EventController";
jotun_gaming_actions_EventController.__interfaces__ = [jotun_gaming_actions_IEventCollection,jotun_gaming_actions_IEventDispatcher];
jotun_gaming_actions_EventController.createContext = function(name,data,provider,controller) {
	return new jotun_gaming_actions_EventContext(name,data,provider,controller,jotun_gaming_actions_EventController._debug);
};
...
jotun_gaming_actions_EventController.prototype = {
	...
	,setDebug: function(mode) {
		jotun_gaming_actions_EventController._debug = mode;
	}
	,_index: null
	,_chain: null
	,call: function(name,data,provider) {
		var context = jotun_gaming_actions_EventController.createContext(name,data,provider,this);
		if(Object.prototype.hasOwnProperty.call(this.events,name)) {
			...
			if(jotun_gaming_actions_EventController._debug) {
				this._onCallBefore(context);
...
jotun_gaming_actions_Events.patch = function(data,validate,priority) {
	var patched = { };
	if(data != null) {
		if(priority != null) {
			jotun_utils_Dice.Values(priority,function(v) {
				if(Object.prototype.hasOwnProperty.call(data,v)) {
					var e = data[v];
					if(!((e) instanceof jotun_gaming_actions_Events)) {
						var value = new jotun_gaming_actions_Events(v,e);
						patched[v] = value;
					} else {
						patched[v] = e;
					}
		...
		jotun_utils_Dice.All(data,function(p,v) {
			...
			if(p != null && p != "") {
				if(!((v) instanceof jotun_gaming_actions_Events)) {
					var value = new jotun_gaming_actions_Events(p,v);
					patched[p] = value;
				} else {
					patched[p] = v;
				}
		...
		if(this._is_waiting == false) {
			...
			if(this._context.ident == 0) {
				if(this._context.debug) {
					jotun_gaming_actions_Events._log(this,this._context);
...
var jotun_logical_BigFlag = $hx_exports["BigFlag"] = function(length) {
	this._parts = [];
	this._build(length);
};
...
var jotun_math_RNG = $hx_exports["JRNG"] = function(seed) {
	if(seed == null) {
		seed = Math.random();
	}
	this.set(seed);
...
jotun_serial_JsonTool.customReplacer = function(a,b) {
	if(typeof(a) == "string") {
		...
		return b.value;
	} else if(js_Boot.__implements(b,jotun_dom_IDisplay)) {
		return b.typeOf();
	}
	return b;
};
jotun_serial_JsonTool.clone = function(obj) {
	return JSON.parse(jotun_serial_JsonTool.stringify(obj));
};
...
var jotun_utils_Delegate = $hx_exports["Delegator"] = function() { };
...
var jotun_utils_Recycler = $hx_exports["J_Recycler"] = function(Object1) {
	this._cache = [];
