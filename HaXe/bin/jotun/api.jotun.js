...
jotun_gaming_actions_Resolution.prototype = {
	...
	,release: function(result,data,name) {
		if(this._stopped) {
			this._stopped = false;
			this.resolve(result,jotun_gaming_actions_EventController.createContext(name,data));
		}
	}
	,connect: function() {
		this._stopped = false;
...
jotun_gaming_actions_ActionQuery.prototype = $extend(jotun_objects_Query.prototype,{
	...
	,tracer: function() {
		...
		haxe_Log.trace("[ActionQuery:tracer] " + jotun_utils_Filler.to(messages.slice().join(" "),this.ioContext),{ fileName : "src/jotun/gaming/actions/ActionQuery.hx", lineNumber : 103, className : "jotun.gaming.actions.ActionQuery", methodName : "tracer"});
		return this;
	}
	,__class__: jotun_gaming_actions_ActionQuery
});
var jotun_gaming_actions_EventContext = function(name,data,debug) {
	this.origin = data;
	this.name = name;
	this.debug = debug;
	this.log = [];
...
jotun_gaming_actions_EventController.createContext = function(name,data) {
	return new jotun_gaming_actions_EventContext(name,data,jotun_gaming_actions_EventController._debug);
};
...
jotun_gaming_actions_EventController.prototype = {
	...
	,call: function(name,data) {
		var context = jotun_gaming_actions_EventController.createContext(name,data);
...
jotun_utils_Singularity._onVisibilityChanged = function(e) {
	...
	haxe_Log.trace(jotun_utils_Singularity.id(),{ fileName : "src/jotun/utils/Singularity.hx", lineNumber : 215, className : "jotun.utils.Singularity", methodName : "_onVisibilityChanged", customParams : [jotun_utils_Singularity._is_active]});
