...
class ErrorCodes {
	...
	static public inline var SESSION_CREATION_ERROR:Int = 2000;
	
	static public inline var SESSION_INVALID_PARAMETERS:Int = 2010;
	
	static public inline var SESSION_USER_NOT_FOUND:Int = 2020;
