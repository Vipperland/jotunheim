...
class EventDispatcher {
	 ...
	 * The Dispatcher control all event dispatched by an object, all handlers return an Event instance [handler(Event)]
	 * @param	q
	 */
	...
	public function cloneFrom(origin:EventDispatcher):EventDispatcher {
