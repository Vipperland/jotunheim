package gate.sirius.isometric.matter {
	...
	import gate.sirius.isometric.math.MatterOffset;
	...
	public class BiomeMatter implements IBiomeMatter {
		...
		/** @private */
		protected var _offset:MatterOffset;
		...
		/**
		 * Precise position for smooth movement
		 */
		public function get offset():MatterOffset {
			return _offset;
		}
		...
		/**
		 * Set the DisplayObject.name equal to Matter.name
		 */
		public function publishName():void {
			if (_content) {
				_content.name = this._name;
			}
		}
