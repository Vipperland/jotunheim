package gate.sirius.isometric.data {
	...
	import gate.sirius.isometric.math.BiomePath;
	...
	public class BiomeEntry {
		...
		public function BiomeEntry(x:int, y:int, z:int, biome:Biome) {
			_biome = biome;
			_path = new BiomePath(BiomePoint.create(x, y, z));
		...
		public function get id():String {
			return "tile_" + location.x + "_" + location.y + "_" + location.z;
		}
